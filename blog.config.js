...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'b23cabddf4cd403395506f5a81377540',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个还在学习的程序员, 欢迎来到我的博客🎉,希望我的博客对你有帮助',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Zwc', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '同济软院的菜鸟一枚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || https://zwc.zeabur.app/', // 网站地址
